...
public class MovingSphere : MonoBehaviour
{
	...
	float maxGroundAngle = 20f, maxStairsAngle = 50f;
	...
	int stepsSinceLastGrounded = 0, stepsSinceLastJump = 0;
	...
	private Quaternion AlignBallRotation(Vector3 rotationAxis, Quaternion rotation, float travelledDistance)
	{
